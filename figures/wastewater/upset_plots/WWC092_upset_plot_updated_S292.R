...
write.table(POS_comb, "POS_comb_S292.txt",na="", sep="\t")
#write.table(POS_comb, "POS_comb_S292_added.txt",na="", sep="\t")

#Delta columne and values added to written file

POS_comb_added <- fread("POS_comb_S292_added.txt")
...
write.xlsx(text_list, "S292_binary.xlsx")
...
count <- data.frame(Caller = c("LoFreq","iVar","GATK","FreeBayes","BCFtools","VarScan"), 
                    ...
                    Found_in_S292_OmicronBA.1 = c(LoFreq_OmicronBA.1,iVar_OmicronBA.1,GATK_OmicronBA.1,FreeBayes_OmicronBA.1,BCFtools_OmicronBA.1,VarScan_OmicronBA.1), 
                    Found_in_S292_OmicronBA.2 = c(LoFreq_OmicronBA.2,iVar_OmicronBA.2,GATK_OmicronBA.2,FreeBayes_OmicronBA.2,BCFtools_OmicronBA.2,VarScan_OmicronBA.2), 
                    Found_in_S292_Delta = c(LoFreq_Delta, iVar_Delta, GATK_Delta, FreeBayes_Delta, BCFtools_Delta, VarScan_Delta))
print(count)
write.xlsx(count, "Found_S292_count.xlsx")
...
ggsave("Upset_plot_WWC092_S292.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
ggsave("Upset_plot_WWC092_S292_wo_lfq.png",units="in", width= 12, height = 6, device='png', dpi=300)
