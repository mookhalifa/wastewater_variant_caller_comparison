...
# read in the data 
original_wd <- getwd()
setwd("/mnt/ramdisk/WWC105_Quasi_GATK_corrected")

quasi_1 <- fread("snpcall_benchmark_DELTA_1.txt")
quasi_2 <- fread("snpcall_benchmark_DELTA_2.txt")
quasi_3 <- fread("snpcall_benchmark_DELTA_3.txt")
...
write.csv(quasi_1_filtered, file="snpcall_benchmark_DELTA_1_filtered.txt")

quasi_merged <- rbind(quasi_1_filtered, quasi_2, quasi_3)
names(quasi_merged)[1] <- "sample"
head(quasi_merged)
write.csv(quasi_merged, file="snpcall_benchmark_DELTA_merged.txt")
write.xlsx(quasi_merged, "snpcall_benchmark_DELTA_merged.xlsx")
...
write.csv(snp_quasi_6VCs_median, file="snp_quasi_DELTA_6VCs_median.txt")
...
write.csv(snp_quasi_6VCs_median_Mix, file="snp_quasi_DELTA_6VCs_median_mix.txt")
...
write.table(snp_quasi_6VCs_median_Mix4_unique, file="DELTA_snp_quasi_6VCs_median_Mix4_unique.txt", sep="\t")
...
point_plot
ggsave("Final_DELTA_Mix_Median_color_by_caller_trend_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_color_by_caller_trend_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_DELTA_Mix_Median_color_by_caller_trend_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("Final_DELTA_Mix_Median_gp_by_caller_trend_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_gp_by_caller_trend_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_DELTA_Mix_Median_gp_by_caller_trend_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("Final_DELTA_Mix_Median_color_by_caller_recall_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_color_by_caller_recall_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_DELTA_Mix_Median_color_by_caller_recall_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_DELTA_Mix_Median_color_by_caller_pre_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_color_by_caller_pre_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_DELTA_Mix_Median_color_by_caller_pre_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
#   theme(legend.position = "bottom")  
# point_plot 
# ggsave("Final_DELTA_Mix_Median_color_by_caller_recall_300_box.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4_unique, aes(recall, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_DELTA_Mix_Median_color_by_caller_recall_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4_unique, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_DELTA_Mix_Median_color_by_caller_pre_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)

#point plotting only the Mix samples by median values colour gradient by DELTA concentration in multi by caller with geom trend line
jit <- position_jitter(seed=123)
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4, aes(precision, recall, color=DELTA)) + 
...
figure_1C <- point_plot
ggsave("Final_DELTA_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
ggsave("Final_DELTA_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_BR_grad_color_by_caller_trend_group_by_color_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)

#plotting only the Mix samples by median values colour caller by DELTA concentration in multi by Mix
point_plot <- ggplot(snp_quasi_6VCs_median_Mix4, aes(precision, recall, color=caller)) + 
  geom_point(size=2.5) + 
  ...
  scale_shape_manual(values=rep(15:22, len=6)) + facet_wrap(facets = ~fct_reorder(as.factor(ID2), -(DELTA), .desc=TRUE)) + coord_cartesian(xlim=c(0,1.0), ylim=c(0,1.0)) +
  theme_bw(base_size=10)
point_plot + theme(legend.position = "bottom")
ggsave("Final_DELTA_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
ggsave("Final_DELTA_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_DELTA_Mix_Median_color_by_caller_group_by_Mix_ID2_sorted_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
