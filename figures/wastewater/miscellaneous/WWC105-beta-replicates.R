...
write.csv(snp_quasi_6VCs_Mix, file="snp_quasi_BETA_6VCs_mix-only_one_genome.txt")
...
ggsave("Final_BETA_Mix_Replicate_color_by_caller_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("Final_BETA_Mix_Replicate_color_by_caller_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("Final_BETA_Mix_Replicate_color_by_caller_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("Final_BETA_only_color_by_caller_recall_300_box_jitterpoints-replicates.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(snp_quasi_6VCs_Mix, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("Final_BETA_only_color_by_caller_pre_300_box_jitterpoints-replicates.png",units="in", width= 12, height = 6, device='png', dpi=300)
