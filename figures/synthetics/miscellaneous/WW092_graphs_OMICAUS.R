...
rm(list=ls())
old_old_wd <- getwd()
setwd("../../../WWC092_Quais_GATK_corrected/")

# read in the data 
ww_quasi <- fread("snpcall_benchmark_OMICAUS.txt")
ww_quasi_1 <- fread("snpcall_benchmark_OMICAUS_1.txt")
head(ww_quasi)
head(ww_quasi_1)
ww_quasi_filtered <-  ww_quasi %>% filter(!str_detect(caller,"GATK"))

write.csv(ww_quasi_filtered, file="snpcall_benchmark_OMICAUS_1_filtered.txt")

quasi_merged <- rbind(ww_quasi_filtered, ww_quasi_1)
names(quasi_merged)[1] <- "sample"
head(quasi_merged)
write.csv(quasi_merged, file="snpcall_benchmark_OMICAUS_merged.txt")
write.xlsx(quasi_merged, "snpcall_benchmark_OMICAUS_merged.xlsx")
...
point_plot 
ggsave("WW092_OMICAUS_color_by_caller_600_1.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_300_1.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICAUS_color_by_caller_600_1.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_300_1.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("WW092_OMICAUS_color_by_caller_multi_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICAUS_color_by_caller_multi_600.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
ggsave("WW092_OMICAUS_color_by_caller_multi_label_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_600.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot
ggsave("WW092_OMICAUS_color_by_caller_recall_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
point_plot <- ggplot(ww_quasi_caller, aes(precision, caller, color=caller)) +
  ...
  theme(legend.position = "bottom")  
point_plot
ggsave("WW092_OMICAUS_color_by_caller_pre_300_box_jitterpoints.png",units="in", width= 12, height = 6, device='png', dpi=300)
