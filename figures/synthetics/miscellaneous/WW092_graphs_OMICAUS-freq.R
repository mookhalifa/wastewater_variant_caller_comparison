...
avg_freq_unique_selected <- avg_freq_unique %>% dplyr::select(samp_desc, Avg_Freq)
...
point_plot
ggsave("WW092_OMICAUS_color_by_caller_multi_600-freq.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_300-freq.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICAUS_color_by_caller_multi_600-freq.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_300-freq.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
ggsave("WW092_OMICAUS_color_by_caller_multi_label_600-freq.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_300-freq.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_600-freq.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICAUS_color_by_caller_multi_label_300-freq.png",units="in", width= 12, height = 6, device='png', dpi=300)
