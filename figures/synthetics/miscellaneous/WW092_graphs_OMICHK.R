...
point_plot
ggsave("WW092_OMICHK_color_by_caller_multi_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICHK_color_by_caller_multi_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICHK_color_by_caller_multi_600.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICHK_color_by_caller_multi_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
...
ggsave("WW092_OMICHK_color_by_caller_multi_label_600.tiff",units="in", width= 12, height = 6, device='tiff', dpi=600)
ggsave("WW092_OMICHK_color_by_caller_multi_label_300.tiff",units="in", width= 12, height = 6, device='tiff', dpi=300)
ggsave("WW092_OMICHK_color_by_caller_multi_label_600.pdf",units="in", width= 12, height = 6, device='pdf', dpi=600)
ggsave("WW092_OMICHK_color_by_caller_multi_label_300.png",units="in", width= 12, height = 6, device='png', dpi=300)
